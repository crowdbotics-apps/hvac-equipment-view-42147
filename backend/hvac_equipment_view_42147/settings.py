"""
Django settings for hvac_equipment_view_42147 project.
...
ROOT_URLCONF = 'hvac_equipment_view_42147.urls'
...
WSGI_APPLICATION = 'hvac_equipment_view_42147.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hvac_equipment_view_42147 API",
    "DESCRIPTION": "API documentation for hvac_equipment_view_42147 App",
    "VERSION": "v1",
}
