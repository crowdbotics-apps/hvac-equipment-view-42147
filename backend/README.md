...
## Project Structure
    ...
    ├── hvac_equipment_view_42147  # Django project configurations
...
1. Clone this repo and `cd hvac_equipment_view_42147`
...
2. Clone this repo and `cd hvac_equipment_view_42147`
